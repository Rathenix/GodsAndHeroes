...
/// <summary>
/// Generates rectangular shaped grid of squares. Meant to be modified for GhSquare specifically but is untested
/// </summary>
[ExecuteInEditMode()]
public class GhSquareGridGenerator : ICellGridGenerator
{
    ...
    public override List<Cell> GenerateGrid()
    {
        ...
        for (int i = 0; i < Width; i++)
        {
            for (int j = 0; j < Height; j++)
            {
                ...
                square.GetComponent<GhSquare>().unitOwner = -1;
